            ...
            <div className="grid grid-2 gap-2xl">
              <div>
                ...
                <div className="flex flex-wrap gap-md mt-xl">
                  ...
                  {/* Phone */}
                  <a href="tel:+12107868576" className="w-16 h-16 rounded-full bg-card border border-subtle flex items-center justify-center hover:border-green-500 hover:bg-green-500/10 transition-all hover:-translate-y-1 group" aria-label="Call or Text Us">
