...
export default function Footer() {
  ...
  const services = [
    ...
    { name: 'Custom Imagery', slug: '#custom-imagery' },
        ...
        <div className={styles.grid}>
          <div className={styles.colInfo}>
            ...
            <div className={styles.socials}>
              <a href="tel:+12107868576" aria-label="Phone" className={styles.socialLink}>
          ...
          <div className={styles.colLinks}>
            ...
            <ul className={styles.linkList}>
              ...
              <li><Link href="/quote" className={styles.link}>Request a Quote</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className={styles.linkList}>
              {services.map(s => (
                <li key={s.slug}><Link href={`/services${s.slug.startsWith('#') ? '' : '/'}${s.slug}`} className={styles.link}>{s.name}</Link></li>
              ))}
            </ul>
          </div>
